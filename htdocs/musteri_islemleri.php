...
function guncelleForm($conn, $musteriID) { // Müşteri güncelleme formu
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<div class='mb-3'><label class='form-label'>Telefon:</label><input type='text' name='tel' value='".$row["tel"]."' class='form-control' required></div>";
...
<div class="container">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        <div class="form-group">
            ...
            <input type="text" name="musteriID" value="1" class="form-control">
        </div>
        <button type="submit" name="getir" class="btn btn-info">Verileri Getir</button>
    </form>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["getir"])) {
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<div class='form-group'><label class='form-label'>Telefon:</label><input type='text' name='tel' value='".$row["tel"]."' class='form-control'></div>";
